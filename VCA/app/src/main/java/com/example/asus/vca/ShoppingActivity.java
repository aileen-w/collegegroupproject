...
public class ShoppingActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {                           //loads shopping activity
        ...
        for (int j=0;j< productsize;j++){
            ...
            //product item is used for each food item in the product order instance,
            ...
            //sets the add to cart button paramaters in the linearlayout
            // for each add to cart button
            buttonBasket.setLayoutParams(params);
            final int index = j;
