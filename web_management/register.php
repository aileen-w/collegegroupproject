<?php
    ...
    {
        if(!empty($_POST['email']) && !empty($_POST['pwd']) && !empty($_POST['rpwd']))
        {
            $register = register($pdo, $_POST['email'], $_POST['pwd'], $_POST['rpwd']);
        }
        else
        {
            $register = '<div class="alert alert-warning" role="alert">Some inputs has been left empty. Please correct and try again.</div>';
        }
    }
...
<!--                        <button class="btn btn-lg btn-primary btn-block" type="submit">Register</button>-->
                        <input id="reg" class="btn btn-lg btn-primary btn-block" type="submit" name="submit" value="Register"/>
